...
if (!submittedHtml) {
  ...
  try {
    ...
    // Captura somente o elemento do card, mantendo exatamente o contexto
    // de layout/fontes em que ele foi renderizado. Como o download deve ser
    // apenas o card, não precisamos incluir margem, sombra externa ou partes
    // da página ao redor.
